...
ADR_TEMPLATES = ROOT / "src" / "cache_freshness_governance_pack" / "templates" / "adr"
SPEC_TEMPLATES = ROOT / "src" / "cache_freshness_governance_pack" / "templates" / "specs"
RESERVATION_OWNER = "extension-pack:cache-freshness-governance-pack"
